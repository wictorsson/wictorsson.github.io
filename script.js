...
filtersEl.addEventListener("click", (e) => {
  ...
  if (filterText === "All") {
    ...
    projectEl6.style.opacity = "1";
    projectEl6.style.transform = "translate(-323px, -323px)";
    ...
    projectEl7.style.opacity = "1";
    projectEl7.style.transform = "translate(0, -323px)";
    projectEl8.style.opacity = "1";
    projectEl8.style.transform = "scale(1)";
    projectEl9.style.opacity = "1";
    projectEl9.style.transform = "translate(0, -323px)";
    projectEl10.style.opacity = "1";
    projectEl10.style.transform = "translate(0, -323px)";
    projectEl11.style.opacity = "0";
    projectEl11.style.transform = "translate(323, -323px)";
